            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed" >
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:void(0)">新增学员</a></dd>
        ...
        <div class="container" style="width: 400px;">
            ...
            <form action="${pageContext.request.contextPath}/addStudentServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="parents" name="parents" placeholder="请输入监护人姓名"/>
                </div>

                <div class="form-group">
                    <label for="sphone">联系方式：</label>
                    <input type="text" class="form-control" id="sphone" name="sphone" placeholder="请输入联系方式"/>
                </div>

                <div class="form-group">
                    <label for="school">就读学校：</label>
                    <input type="text" class="form-control" id="school" name="school" placeholder="请输入就读学校"/>
                </div>

                <div class="form-group">
                    <label for="cno">班级名称：</label>
